...
/// <summary>
/// Resolves Iw4Radiant's per-user configuration file independently from the
/// editor executable and IW4 Studio's settings namespace.
/// </summary>
internal static class RadiantSettingsPath
{
    private const string ApplicationNamespace = "Iw4Radiant";
