...
/// </summary>
public static class MapRenderEditorTranslatedProgramCapability
{
    ...
    /// </summary>
    public static MapRenderFragmentTargetOutputAvailability
    ...
    public static IReadOnlyList<string> FindBlockers(
        ...
        MapRenderFragmentTargetOutputAvailability targetOutputs)
    {
