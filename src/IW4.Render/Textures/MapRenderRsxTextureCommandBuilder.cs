...
public static class MapRenderRsxTextureCommandBuilder
{
    public static MapRenderRsxTextureCommandState FromImage(GfxImageAsset image)
    {
        return new MapRenderRsxTextureCommandState(
            image.PixelsOffset,
    ...
    public static MapRenderRsxTextureCommandState FromDescriptor(GfxTexture texture)
    {
