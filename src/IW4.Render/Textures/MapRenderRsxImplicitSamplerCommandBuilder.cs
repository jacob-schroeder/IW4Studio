...
/// </summary>
public static class MapRenderRsxImplicitSamplerCommandBuilder
{
        ...
        MapRenderWorldRuntimeTextureKind kind)
    {
        ...
        [
            new MapRenderRsxMethodPacket(
                MapRenderSamplerDecoder.RsxTexEnableMethod(sampler),
                [0x80060000u]),
            new MapRenderRsxMethodPacket(
                MapRenderSamplerDecoder.RsxTexFilterMethod(sampler),
                [filterPayload]),
            new MapRenderRsxMethodPacket(
                MapRenderSamplerDecoder.RsxTexWrapMethod(sampler),
                [0x40010303u])
        ]);
    }
