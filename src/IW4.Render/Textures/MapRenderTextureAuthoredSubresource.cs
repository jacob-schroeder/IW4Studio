...
/// </summary>
public enum MapRenderAuthoredBlockCompression
{
    Unknown,
    Bc1,
    Bc2,
...
/// </summary>
public sealed class MapRenderTextureAuthoredSubresource
{
    private readonly byte[] _payload;

    public MapRenderTextureAuthoredSubresource(
        int faceOrdinal,
        int mipLevel,
        int width,
        int height,
        ...
        bool isDirectUploadLayoutProven = false)
    {
        ...
        if (blockCompression != MapRenderAuthoredBlockCompression.Unknown)
        {
    ...
    public MapRenderAuthoredBlockCompression BlockCompression { get; }
