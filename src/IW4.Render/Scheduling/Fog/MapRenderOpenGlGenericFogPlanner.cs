...
public static class MapRenderGenericFogPlanner
{
    ...
    private static MapRenderGenericFogPlan FromActiveFog(
        ...
        bool shaderConsumesLinearFogColor)
    {
        IReadOnlyDictionary<int, MapRenderShaderConstantValue> rows =
            FrameDirectCodeConstants
                ...
                .ToDictionary(
                    ...
                    row => row.Value);
        MapRenderShaderConstantValue fogRow =
            rows[FrameDirectCodeConstants.FogRowIndex];
        MapRenderShaderConstantValue fogColor = rows[
            shaderConsumesLinearFogColor
        ...
        MapRenderShaderConstantValue sunFogColor = fogColor;
        MapRenderShaderConstantValue sunFogConstants = default;
        ...
        if (sunFogEnabled)
        {
            ...
            MapRenderShaderConstantValue gameDirection =
                rows[FrameDirectCodeConstants.SunFogDirectionRowIndex];
            renderSunFogDirection = MapRenderCoordinateConverter
