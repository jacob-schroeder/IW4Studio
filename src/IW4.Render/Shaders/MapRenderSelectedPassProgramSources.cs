...
public sealed class MapRenderSelectedPassProgramSources
{
    private readonly MaterialShaderArgumentAsset[] _arguments;

    public MapRenderSelectedPassProgramSources(
        MaterialVertexDeclarationAsset? vertexDeclaration,
        MapRenderShaderProgramResolution vertexProgram,
        MapRenderShaderProgramResolution pixelProgram,
    ...
    public MapRenderShaderProgramResolution VertexProgram { get; }

    public MapRenderShaderProgramResolution PixelProgram { get; }
