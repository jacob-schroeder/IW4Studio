...
/// </summary>
internal static class MapRenderSelectedProgramVertexConstantOwnership
{
        ...
        IReadOnlyList<MapRenderEmbeddedVertexConstant> embeddedConstants)
    {
        ...
        {
            if (destination is < 0 or >= MapRenderRsxVertexConstantLayout.Count)
            {
                blockers.Add(
        ...
        foreach (MapRenderEmbeddedVertexConstant embedded in
                 embeddedConstants)
        {
