...
internal sealed class ClipMapAssetLoader : XAssetLoader<ClipMapAsset>
{
    ...
    public ClipMapAssetLoader(XAssetType serializedType)
        : base(serializedType, ClipMapAsset.SerializedSize, "clipMap_t")
    {
    }

    protected override ClipMapAsset RegisterAsset(
        ClipMapAsset asset,
        ProviderRegistrationOccurrence providerRegistration,
        DbLoadExecutionContext context) =>
        context.DB_AddXAsset(AssetType, asset, providerRegistration);

    protected override ClipMapAsset ReadBody(
        FastFileCursor cursor,
        XBlockAddress expectedRootAddress,
        DbLoadExecutionContext context)
    {
        XAssetType serializedType = AssetType;
