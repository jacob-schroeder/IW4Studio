...
using SoundAliasListAssetModel = IW4.Game.Assets.Sound.SoundAliasListAsset;
...
public sealed class MenuDefLoader : XAssetLoader<MenuDefAsset>
{
    ...
    public MenuDefLoader()
        : base(XAssetType.Menu, MenuDefSize, "MenuDef")
    {
    }

    internal MenuDefAsset? SourceMenu { get; private set; }

    protected override MenuDefAsset ReadBody(
        FastFileCursor cursor,
        XBlockAddress rootAddress,
        DbLoadExecutionContext context)
    {
        MenuDefAsset menu = ReadMenuDefRoot(cursor, rootAddress, context);
    ...
    protected override MenuDefAsset RegisterAsset(
        MenuDefAsset asset,
    ...
    internal static InvalidDataException UnsupportedDirectTablePointer(
        XPointerReference pointer,
        string name) =>
        new(
    ...
    internal static XPointer<T> ReadCountedPointer<T>(
        FastFileCursor cursor,
        DbLoadExecutionContext context,
        XPointerResolutionMode resolutionMode,
        int count,
    ...
    internal static void AlignStream(
        FastFileCursor cursor,
        DbLoadExecutionContext context,
        int alignment)
    {
