...
namespace IW4.Loaders.Assets.StructuredData;

public sealed class StructuredDataDefSetLoader : XAssetLoader<StructuredDataDefSetAsset>
{
    public StructuredDataDefSetLoader() : base(XAssetType.StructuredDataDef, StructuredDataDefSetAsset.SerializedSize, "StructuredDataDefSet")
    {
    }

    protected override StructuredDataDefSetAsset RegisterAsset(
    ...
    protected override StructuredDataDefSetAsset ReadBody(
