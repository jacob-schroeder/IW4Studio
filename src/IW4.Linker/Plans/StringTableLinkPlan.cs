...
/// <summary>
/// Frozen StringTable plan. The complete row-major cell table is emitted
/// before any cell XString bodies, matching the native counted-array walk.
/// </summary>
internal sealed class StringTableLinkPlan : AssetLinkPlan
{
    private const int MaximumCellCount = 0x100000;

    private StringTableLinkPlan(
        AssetKey key,
        ...
        LinkAssetFreezeScope freeze)
    {
        ...
        return new StringTableLinkPlan(
            key,
            originalSerializedName,
