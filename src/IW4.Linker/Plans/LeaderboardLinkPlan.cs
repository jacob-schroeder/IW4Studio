...
internal sealed class LeaderboardLinkPlan : AssetLinkPlan
{
    private LeaderboardLinkPlan(
        AssetKey key,
        ...
        LinkAssetFreezeScope freeze)
    {
        ...
        return new LeaderboardLinkPlan(key, originalSerializedName, definition, freeze);
    }
