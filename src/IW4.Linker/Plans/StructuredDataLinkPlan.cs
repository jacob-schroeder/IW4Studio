...
/// </summary>
internal sealed class StructuredDataLinkPlan : AssetLinkPlan
{
    private StructuredDataLinkPlan(
        AssetKey key,
        ...
        LinkAssetFreezeScope freeze)
    {
        ...
        return new StructuredDataLinkPlan(key, originalSerializedName, definition, freeze);
    }
