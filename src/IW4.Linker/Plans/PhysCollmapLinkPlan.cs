...
/// while freezing direct-storage views and never survive in the plan.
/// </summary>
internal sealed class PhysCollmapLinkPlan : AssetLinkPlan
{
    private PhysCollmapLinkPlan(
        AssetKey key,
        ...
        LinkAssetFreezeScope freeze)
    {
        ...
        return new PhysCollmapLinkPlan(
            key,
            originalSerializedName,
            definition,
            freeze);
