...
/// </summary>
internal sealed class GameWorldSpLinkPlan : AssetLinkPlan
{
    private GameWorldSpLinkPlan(
        AssetKey key,
        ...
        LinkAssetFreezeScope freeze)
    {
        ...
        return new GameWorldSpLinkPlan(key, originalSerializedName, definition, freeze);
    }
