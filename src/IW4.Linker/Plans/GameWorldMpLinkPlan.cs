...
internal sealed class GameWorldMpLinkPlan : AssetLinkPlan
{
    private GameWorldMpLinkPlan(
        AssetKey key,
        ...
        LinkAssetFreezeScope freeze)
    {
        ...
        return new GameWorldMpLinkPlan(key, originalSerializedName, definition, freeze);
    }
}
