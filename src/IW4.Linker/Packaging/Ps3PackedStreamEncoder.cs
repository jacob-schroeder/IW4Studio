...
internal static class Ps3PackageFormat
{
...
internal sealed class Ps3PackedStream
{
    public Ps3PackedStream(byte[] bytes)
    {
...
/// </summary>
internal static class Ps3PackedStreamEncoder
{
    public const int LogicalPageSize = 0x10000;

    private const ushort TerminatorWord = 1;

    public static Ps3PackedStream Encode(
        ...
        int terminatorCount)
    {
        ...
        return new Ps3PackedStream(output.ToArray());
    }
