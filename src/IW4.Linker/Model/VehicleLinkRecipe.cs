...
/// </summary>
internal sealed class VehicleLinkRecipe : AssetLinkRecipe
{
    private VehicleLinkRecipe(
        AssetKey key,
        ...
        LinkAssetFreezeScope freeze)
    {
        ...
        return new VehicleLinkRecipe(key, originalSerializedName, definition, freeze);
    }
