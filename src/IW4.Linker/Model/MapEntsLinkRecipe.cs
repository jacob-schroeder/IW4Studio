...
internal sealed class MapEntsLinkRecipe : AssetLinkRecipe
{
    private MapEntsLinkRecipe(
        AssetKey key,
    ...
    {
        LinkStorageSymbol? entity = MapEntsRecipeStorage.CreateBytes(
            definition.EntityStringBytes,
            alignment: 1);
        LinkStorageSymbol? models = MapEntsRecipeStorage.CreateModels(
            definition.Trigger.Models);
        LinkStorageSymbol? hulls = MapEntsRecipeStorage.CreateHulls(
            definition.Trigger.Hulls);
        LinkStorageSymbol? slabs = MapEntsRecipeStorage.CreateSlabs(
        ...
        MapEntsRecipeStorage.WriteTriggerHeader(writer, definition.Trigger);
        writer.Skip(sizeof(int));
        ...
        LinkAssetFreezeScope freeze)
    {
        ...
        MapEntsRecipeStorage.ValidateCommon(
            definition.EntityStringBytes,
        ...
        {
            if (!MapEntsRecipeStorage.IsEmptyCommon(
                    definition.EntityStringBytes,
                    definition.NumEntityChars,
                    definition.Trigger) ||
                stages.Count != 0 ||
        ...
        return new MapEntsLinkRecipe(key, originalSerializedName, definition, freeze);
    }
        ...
        LinkStorageSymbol? stages)
    {
        ...
        if (entity is not null)
            yield return MapEntsRecipeStorage.Presence(root, 0x04, entity, "MapEnts.EntityString");
        if (models is not null)
            yield return MapEntsRecipeStorage.Presence(root, 0x10, models, "MapEnts.Trigger.Models");
        if (hulls is not null)
            yield return MapEntsRecipeStorage.Presence(root, 0x18, hulls, "MapEnts.Trigger.Hulls");
        if (slabs is not null)
            yield return MapEntsRecipeStorage.Presence(root, 0x20, slabs, "MapEnts.Trigger.Slabs");
        if (stages is not null)
            yield return MapEntsRecipeStorage.Presence(root, 0x24, stages, "MapEnts.Stages");
    }
        ...
        LinkAssetFreezeScope freeze)
    {
        ...
        for (int index = 0; index < values.Count; index++)
        {
            ...
            writer.Skip(sizeof(int));
            MapEntsRecipeStorage.WriteVec3(writer, value.Origin);
...
internal sealed class AddonMapEntsLinkRecipe : AssetLinkRecipe
{
    private AddonMapEntsLinkRecipe(
        AssetKey key,
        string originalSerializedName,
        ...
        LinkAssetFreezeScope freeze)
    {
        ...
        return new AddonMapEntsLinkRecipe(key, originalSerializedName, definition, freeze);
    }
        ...
        LinkStorageSymbol? slabs)
    {
        yield return NameOperation(root, 0);
        if (entity is not null)
            yield return MapEntsRecipeStorage.Presence(root, 0x04, entity, "AddonMapEnts.EntityString");
        if (models is not null)
            yield return MapEntsRecipeStorage.Presence(root, 0x10, models, "AddonMapEnts.Trigger.Models");
        if (hulls is not null)
            yield return MapEntsRecipeStorage.Presence(root, 0x18, hulls, "AddonMapEnts.Trigger.Hulls");
        if (slabs is not null)
            yield return MapEntsRecipeStorage.Presence(root, 0x20, slabs, "AddonMapEnts.Trigger.Slabs");
    }
}

internal static class MapEntsRecipeStorage
{
