...
/// </summary>
internal sealed class ExternalAssetLinkRecipe : AssetLinkRecipe
{
    private ExternalAssetLinkRecipe(
        AssetKey key,
    ...
    public static ExternalAssetLinkRecipe Create(
        AssetKey key,
        ...
        LinkAssetFreezeScope freeze)
    {
        ...
        return new ExternalAssetLinkRecipe(
            key,
            originalSerializedName,
            rootSize,
            namePointerOffset,
    ...
    public static ExternalAssetLinkRecipe CreateSynthetic(
        AssetKey key,
        XAssetType serializedType,
        string originalSerializedName)
    {
