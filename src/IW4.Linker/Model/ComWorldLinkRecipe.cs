...
internal sealed class ComWorldLinkRecipe : AssetLinkRecipe
{
    private ComWorldLinkRecipe(
        AssetKey key,
        ...
        LinkAssetFreezeScope freeze)
    {
        ...
        return new ComWorldLinkRecipe(key, originalSerializedName, definition, freeze);
    }
