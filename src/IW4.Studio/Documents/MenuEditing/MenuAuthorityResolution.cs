...
public sealed class MenuAuthorityResolutionSnapshot
{
    ...
    /// <summary>
    /// Editor and emitter validation for the exact target definition that
    /// owns this resolution. Authority conflicts remain available separately
    /// through <see cref="Issues"/>.
    /// </summary>
