...
/// <summary>
/// Immutable pool-revision snapshot consumed by the GSC language workspace.
/// The optional overlay never changes the detached base capture.
/// </summary>
public sealed class GscWorkspaceSnapshot
{
    ...
    /// <summary>
    /// Language-neutral semantic index built exclusively from active provider
    /// sources, with <see cref="Overlay"/> applied when present.
    /// </summary>
