...
/// </summary>
internal static class MapRenderOpenGlDirectProgramKeyFactory
{
    private const string ProfileSchema = "direct-rsx-link/v1";

    internal static MapRenderOpenGlProgramKey Create(
        string vertexGlsl,
        string pixelGlsl,
        string compilerLinkProfileIdentity,
        bool staticModelInstancingReady,
        ReadOnlySpan<int> samplerDestinations)
    {
        ...
        return MapRenderOpenGlProgramKey.Create(
            vertexGlsl,
            pixelGlsl,
        ...
        ReadOnlySpan<int> samplerDestinations)
    {
        ...
        builder.Append('|');
        builder.Append(staticModelInstancingReady ? '1' : '0');
        builder.Append('|');
        builder.Append(
