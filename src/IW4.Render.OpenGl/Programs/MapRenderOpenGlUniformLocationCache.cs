...
/// </summary>
internal sealed class MapRenderOpenGlUniformLocationCache
{
    ...
    internal MapRenderOpenGlUniformLocationCache(
    ...
    internal MapRenderOpenGlUniformLocationCacheTelemetry CreateTelemetry()
    {
        EnsureOwnerThread();
        return new(
...
internal readonly record struct MapRenderOpenGlUniformLocationCacheTelemetry(
    long RequestCount,
    long QueryCount,
    long CacheHitCount,
    int ProgramCount);
