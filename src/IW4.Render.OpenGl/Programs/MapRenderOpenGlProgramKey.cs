...
/// </summary>
public readonly struct MapRenderOpenGlProgramKey : IEquatable<MapRenderOpenGlProgramKey>
{
    private readonly string? _vertexGlsl;
    private readonly string? _pixelGlsl;

    private MapRenderOpenGlProgramKey(
        string vertexGlsl,
    ...
    public static MapRenderOpenGlProgramKey Create(
        string vertexGlsl,
        string pixelGlsl,
        string linkProfileIdentity)
    {
        ...
        return new MapRenderOpenGlProgramKey(
            vertexGlsl,
    ...
    public bool Equals(MapRenderOpenGlProgramKey other) =>
        ExactTextEquals(
            VertexGlslSha256,
            _vertexGlsl,
    ...
    public override bool Equals(object? obj) =>
        obj is MapRenderOpenGlProgramKey other && Equals(other);
    ...
    public static bool operator ==(
        MapRenderOpenGlProgramKey left,
        MapRenderOpenGlProgramKey right) => left.Equals(right);
