...
/// </summary>
internal sealed class MapRenderOpenGlLinkedProgramHandleCache
{
    private readonly Dictionary<
        MapRenderOpenGlLinkedProgramHandleCacheKey,
        MapRenderOpenGlLinkedProgramHandleResolution> _resolutions = [];
    ...
    internal MapRenderOpenGlLinkedProgramHandleCache(
        ...
        int usageLane = 0)
    {
        ...
        var key = new MapRenderOpenGlLinkedProgramHandleCacheKey(
            usageLane,
        ...
        if (_resolutions.TryGetValue(
                key,
                out MapRenderOpenGlLinkedProgramHandleResolution cached))
        {
...
internal readonly record struct MapRenderOpenGlLinkedProgramHandleCacheKey(
    int UsageLane,
