...
internal sealed class XAssetCanonicalProjection
{
    ...
    private static GfxImageAsset CreateProjectedImage(
        ...
        new()
        {
            ...
            TextureControl1 = destination.TextureControl1,
            Width = destination.Width,
            Height = destination.Height,
            Depth = destination.Depth,
            MemoryLocation = destination.MemoryLocation,
            MinLodControl = destination.MinLodControl,
            ...
            UseSrgbReads = destination.UseSrgbReads,
