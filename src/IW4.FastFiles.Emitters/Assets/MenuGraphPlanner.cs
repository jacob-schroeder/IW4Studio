...
internal sealed class MenuGraphPlanner
{
    ...
    private PlannedNode PlanItemNode(ItemDefAsset value)
    {
        ...
        writer.WriteInt32((int)value.Type); writer.WriteInt32(value.DataType); writer.WriteInt32(value.Align); writer.WriteInt32(value.FontEnum); writer.WriteInt32(value.TextAlignMode); writer.WriteSingle(value.TextAlignX); writer.WriteSingle(value.TextAlignY); writer.WriteSingle(value.TextScale); writer.WriteInt32(value.TextStyle); writer.WriteInt32(value.GameMsgWindowIndex); writer.WriteInt32(value.GameMsgWindowMode);
        writer.WriteInt32(Pointer(text)); writer.WriteInt32(value.TextSaveGameInfo); writer.WriteInt32(value.RuntimeParentPointer);
        ...
        writer.WriteInt32(Pointer(dvar)); writer.WriteInt32(Pointer(dvarTest)); writer.WriteInt32(Pointer(onKey)); writer.WriteInt32(Pointer(enableDvar)); writer.WriteInt32(value.DvarFlags); writer.WriteInt32(Pointer(focusSound)); writer.WriteSingle(value.Special); WriteInts(writer, value.CursorPos, 4, "ItemDef.cursorPos");
