...
public static class MaterialPreviewDrawing
{
    public static void Apply(GL gl, MaterialSurfaceState state, int alphaTestLocation, int premultiplyAlphaLocation, int ignoreVertexColorLocation)
    {
    ...
    public static void ApplyCull(GL gl, GfxCullFace cull)
    {
    ...
    public static int AlphaTestCode(GfxAlphaTest? alphaTest) => alphaTest switch
    {
