...
/// <summary>
/// Resolves retained pointer occurrences against one frozen symbolic zone
/// object. Physical coordinates are consumed only as occurrence lookup data
/// and never become identities in the canonical link request.
/// </summary>
