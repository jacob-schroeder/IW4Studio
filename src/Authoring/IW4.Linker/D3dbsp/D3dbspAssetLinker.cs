    ...
    IReadOnlyList<XModelAsset> AvailableXModels)
{
    ...
    // Conservative displacement on each axis, weighted by the render vertex red channel.
    public IReadOnlyDictionary<string, float> MaterialDisplacements { get; init; } =
...
public static class D3dbspAssetLinker
{
    ...
    public static D3dbspLinkResult Link(D3dbspLinkRequest request)
    {
        ...
        IReadOnlyList<IW4.Game.Math.Vec3> collisionVerts =
        ...
        GfxWorldAsset gfxWorld = D3dbspGfxCodec.DecodeWorld(
            ...
            materialDisplacements: request.MaterialDisplacements);
