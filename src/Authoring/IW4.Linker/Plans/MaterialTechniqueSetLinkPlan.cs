...
/// </summary>
internal sealed class MaterialTechniqueSetLinkPlan : AssetLinkPlan
{
    private MaterialTechniqueSetLinkPlan(
        AssetKey key,
        ...
        LinkAssetFreezeScope freeze)
    {
        ...
        return new MaterialTechniqueSetLinkPlan(
            key,
            originalSerializedName,
            definition,
            freeze);
        ...
        MaterialTechniqueSetAsset definition)
    {
        ...
        if (techniques.Any(slot => slot.Technique is not null ||
                slot.Pointer.Type != IW4.Game.Pointers.PointerType.Null))
        {
            throw new InvalidDataException(
    ...
    private sealed class StorageFreezer
    {
        ...
        public IEnumerable<LinkOperation> CreateRootOperations(
            ...
            MaterialTechniqueSetLinkPlan plan,
            IReadOnlyList<MaterialTechniqueSlot> techniques)
        {
            yield return plan.NameOperation(root, 0);
        ...
        private LinkStorageTarget FreezeTechnique(
            IW4.Game.Pointers.XPointerReference pointer,
