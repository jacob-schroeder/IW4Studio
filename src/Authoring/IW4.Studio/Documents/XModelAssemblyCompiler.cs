...
public static class XModelAssemblyCompiler
{
    ...
    public static XModelAssemblyCompileResult Compile(XModelDraft draft)
    {
        ...
        var materials = new List<IW4.Game.Assets.Material.MaterialAsset?>();
    ...
    private static void CopyBaselineMaterialRows(XModelAsset model, XModelLodInfo lod, List<IW4.Game.Assets.Material.MaterialAsset?> materials, List<ushort> invHigh, int lodIndex, List<AssetValidationIssue> issues)
    {
    ...
    private static XModelAsset CopyWithAssembly(XModelAsset value, IReadOnlyList<XModelLodInfo> lods, IReadOnlyList<IW4.Game.Assets.Material.MaterialAsset?> materials, IReadOnlyList<ushort> invHigh, byte numSurfs, byte numLods, byte maxLoaded, byte collLod, IReadOnlyList<XModelCollSurf> collisionSurfaces, IW4.Game.Assets.Physics.PhysPresetAsset? physPreset, IW4.Game.Assets.Physics.PhysCollmapAsset? physCollmap, Bounds bounds, float radius, IReadOnlyList<XBoneInfo> boneInfo) => new()
    {
